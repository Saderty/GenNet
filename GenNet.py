...
def load_caffe_models():
    ...
    gender_net1 = cv2.dnn.readNetFromCaffe('deploy_gender.prototxt', 'gender_net.caffemodel')
    return age_net1, gender_net1
...
if __name__ == "__main__":
    age_net2, gender_net2 = load_caffe_models()
    video_detector(age_net2, gender_net2)
